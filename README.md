...
To add more links just change the javascript section in [js/myscript.js](https://github.com/fdiengdoh/fdiengdoh.github.io/blob/main/js/myscript.js). Find the following code block:
